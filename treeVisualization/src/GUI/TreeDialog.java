...
public class TreeDialog {
	 ...
	 public static int showDeleteDialog() {
	        Dialog<Integer> dialog = new Dialog<>();
	        dialog.setTitle("Node Delete");

	        TextField txtNodeValue = new TextField();
	        txtNodeValue.setPromptText("Enter value to delete");
	 ...
	 public static int[] showUpdateDialog() {
	        ...
	        TextField txtParentValue = new TextField();
	        txtParentValue.setPromptText("Enter Old Value");

	        TextField txtChildValue = new TextField();
	        txtChildValue.setPromptText("Enter New Value");
